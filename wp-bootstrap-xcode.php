...
if ( ! class_exists( 'WP_Bootstrap_Xcode' ) ) :
	class WP_Bootstrap_Xcode extends Walker_Nav_Menu {
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= "\n<ul" . $id . $class . '>';
			$fallback_output .= "\n".'<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link text-dark" title="' . esc_attr__( 'Add a menu', 'wp-bootstrap-navwalker' ) . '">' . esc_html__( 'Add a menu', 'wp-bootstrap-navwalker' ) . '</a></li>';
			$fallback_output .= "</ul>\n";
